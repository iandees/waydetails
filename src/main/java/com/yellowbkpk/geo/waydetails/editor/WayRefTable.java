...
public class WayRefTable extends JTable implements INodeRefModelListener {
     ...
     * @param columnModel
     */
    public WayRefTable(OsmDataLayer layer, WayRefTableModel model) {
        super(model, new WayRefTableColumnModel(layer.data), model.getSelectionModel());
        this.layer = layer;
    ...
    protected WayRefTableModel getMemberTableModel() {
        return (WayRefTableModel) getModel();
    }
